...
__turner_inline_var constexpr message_type_t
  allocation = request_v<0x003>;

/**
 * TURN Allocation success response
 */
__turner_inline_var constexpr message_type_t
  allocation_success = success_response_v<allocation>;

/**
 * TURN Allocation error response
 */
__turner_inline_var constexpr message_type_t
  allocation_error = error_response_v<allocation>;
 ...
 */
__turner_inline_var constexpr message_type_t
  refresh = request_v<0x004>;

/**
 * TURN Refresh success response
 */
__turner_inline_var constexpr message_type_t
  refresh_success = success_response_v<refresh>;

/**
 * TURN Refresh error response
 */
__turner_inline_var constexpr message_type_t
  refresh_error = error_response_v<refresh>;
 ...
 */
__turner_inline_var constexpr message_type_t
  send_indication = indication_v<0x006>;
 ...
 */
__turner_inline_var constexpr message_type_t
  data_indication = indication_v<0x007>;
 ...
 */
__turner_inline_var constexpr message_type_t
  create_permission = request_v<0x008>;

/**
 * TURN CreatePermission success response
 */
__turner_inline_var constexpr message_type_t
  create_permission_success = success_response_v<create_permission>;

/**
 * TURN CreatePermission error response
 */
__turner_inline_var constexpr message_type_t
  create_permission_error = error_response_v<create_permission>;
 ...
 */
__turner_inline_var constexpr message_type_t
  channel_bind = request_v<0x009>;

/**
 * TURN ChannelBind success response
 */
__turner_inline_var constexpr message_type_t
  channel_bind_success = success_response_v<channel_bind>;

/**
 * TURN ChannelBind error response
 */
__turner_inline_var constexpr message_type_t
  channel_bind_error = error_response_v<channel_bind>;
